...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <div class="wrap">
            <div class="container">
                <?php if (Yii::app()->defaultController == Yii::app()->controller->id . '/' . $this->action->id || 'error' == $this->action->id): ?>
                    <?php echo $content; ?>
                <?php else: ?>
                    <?php echo $this->renderPartial('//layouts/content', array('content' => $content)); ?>
                <?php endif; ?>
            </div>
        </div>
